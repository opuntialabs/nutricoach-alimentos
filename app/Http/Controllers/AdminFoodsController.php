<?php namespace App\Http\Controllers;
	...
	class AdminFoodsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Unidad","name"=>"unit_id","join"=>"units,id"];
			$this->col[] = ["label"=>"Porción","name"=>"measure_id","join"=>"measures,id"];
			$this->col[] = ["label"=>"Medida Casera","name"=>"home_measure_id","join"=>"home_measures,id"];
			$this->col[] = ["label"=>"Calorías","name"=>"calories"];
			$this->col[] = ["label"=>"Grupo de Alimentos","name"=>"food_group_id","join"=>"food_groups,id"];
